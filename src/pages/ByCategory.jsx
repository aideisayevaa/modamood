...
function ByCategory({ products, basket, favorite, dispatch, categories, subcategories, aLang, t, singleuser }) {
    // console.log("rrrrrrrrrrrrrrr" + cat)
                                ...
                                <aside>
                                    <div>
                                        <div>
                                                    ...
                                                    <Swiper
                                                        ...
                                                        {allColors.filter((a, b) => b === allColors.indexOf(a)).map(c =>
                                                            <SwiperSlide id={nanoid()}>
                                                                <li onClick={() => setSelectedColorFilter(c)}>
                                            ...
                                            }} className='filter__clean'>{t[aLang].clearFilter}</button>
                                        </div>
                                    </div>
                                </aside>
                                <main>
                                                    ...
                                                    <li key={product.id} id={listView && "list__view"} >
                                                        ...
                                                        <motion.section initial={{ opacity: 0, transform: "scale(0.9)" }} animate={{ opacity: 1, transform: "scale(1)" }} transition={{ duration: 0.4, property: "transform" }}>
                                                            ...
                                                            <ul className={!singleuser.name?"product_icons product_icons_important":"product_icons"} onClick={(e) => e.stopPropagation()} style={{ display: selectedOverlay.status ? "none" : "block" }}>
                                                                ...
                                                                }} style={{ left: !singleuser.name && "50% !important", transform: !singleuser.name && "translateX(-50%) !important" }}><i className="fa-solid fa-magnifying-glass-plus"></i></li>
                                                                {singleuser.name && <>
                                                                    {check ? (
...
const t = a => a
export default connect(t)(ByCategory)